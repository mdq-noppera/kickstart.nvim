...
```sh
git clone https://github.com/mdq-noppera/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/mdq-noppera/kickstart.nvim.git %userprofile%\AppData\Local\nvim\
```
